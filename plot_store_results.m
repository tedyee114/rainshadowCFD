...
%     figure(2);
%     hold off; 
%     u_temp = [u_bot+zeros(1,N.x_u); u_guess; u_top+zeros(1,N.x_u)];
%     v_temp = [v_lef+zeros(N.y_v,1)  v_guess  v_rig+zeros(N.y_v,1)];
% 
...
% 
%     imagesc(x_p,y_p,reshape(p_guess,N.y_p,N.x_p)); hold on;
% 
%     colormap jet
%     quiver(X,Y,U,V,'k')
